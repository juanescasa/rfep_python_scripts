...
table_name= '\MaeVehicles.csv'
table_path = folder + table_name
...
table_name = '\\SuppliersRanges.csv'
table_path = folder + table_name
...
table_name = '\\NodesNodesPaths.csv'
table_path = folder + table_name
