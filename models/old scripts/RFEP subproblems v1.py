...
#df_times = pd.DataFrame({'process':['data reading'], 'start_time':[time.time()],
#                         'end_time':[0], 'total_time':[0]})

#df_times.append({'process':['next data reading'], 'start_time': [time.time()], 
#                 'end_time':[0], 'total_time':[0]}, ignore_index=True)
...
file = "C:\OneDrive - Deakin University\OD\calle test\Disun Applications\Gurobi Applications\data\Data Model Generated Network-14.xlsm"
sh = 'MaeVehicles'
